...
{
    // What is changed from Leslie's script:
    // removed instantiation of her splatter effect
    // changed grounding layer to Ground (in inspector)
    // changed blood splat to my prefab (in inspector)
